...
<form name="adminAction" method="post" action="" enctype="multipart/form-data">
    <h2 class="left">Manage Media Links</h2>
     <div class="right new_entry"><a href="javascript: void(0)" onclick="showFile()">ADD New Link</a><br /><br />
	
	 <div id="file_holder" style="display: none;">
	            Title &nbsp;&nbsp;&nbsp;&nbsp;: <input type="text" name="link_title"  class="input-text-box" size="38" />
	            <span class="clear"></span>
			    Image : <input type="file" name="media_slide_image"/>
			    <span class="clear"></span>
                ...
                if($slider_images)
                {
                    foreach($slider_images as $key=>$value)
                    {
                        ...
                        <tr class="<?php echo $trclass; ?>" id="<?php echo 'row_'.$key ?>">
                            ...
                            <td><?php echo $value['img_extra'] ?></td>

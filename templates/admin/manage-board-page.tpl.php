...
<div class="block">
    ...
    <h2 class="left">Manage Board Pages</h2>
    <div class="right new_entry"><a href="<?php echo ADMIN_URL.'add_board_page' ?>">ADD New Board Page</a></div> 
    <div class="clear"></div>
            ...
            <table cellpadding="0" cellspacing="0" class="table">
               <thead class="thead">
                <tr>
                    ...
                    <th width="35%">Board Title</th>
                    <th width="35%">Board Image</th>
            ...
            <?php
                if($boardLists)
                {
                    foreach($boardLists as $key=>$value)
                    {
                        ...
                        $iamge_info = getSingleImage(array("res_id"=>$value['res_id']));
                        ?>
                        <tr class="<?php echo $trclass; ?>" id="<?php echo 'row_'.$key ?>">
                            ...
                            <td><?php if($iamge_info['image_name']){ ?>
                            ...
                            <td style="text-align: center;">                                 
                                <a href="<?php echo ADMIN_URL.'add_board_page/'.$value['res_id']; ?>" title="Modify Board Page Information"><img src="<?php echo ADMIN_CSS_URL ?>images/edit.png" width="12" height="14" alt="Edit"  /></a>&nbsp;&nbsp;                                                                
                                <a href="javascript:void(0);" onclick="deleteArticle('<?php echo $key; ?>','<?php echo $value['res_id'] ?>')" title="Remove Board Page"><img src="<?php echo ADMIN_CSS_URL ?>images/delete.png" width="14" height="14" alt="Delete"  /></a>
                            </td>
                        </tr>
                        <?php
                    }

<?php global $insuredInfo,$insuredLists,$footerFunctions,$policyInfo;

$footerFunctions = array("scriptHealthRateup");

$policylist = getSinglePolicy($insuredInfo['idpolicy']);
//$insuredLists = getHealthInsuredLists($insuredInfo['idpolicy']);
//$rateups = getRateUpByInsured($insuredInfo['id']);
    ...
    <th colspan="4" bgcolor="#f3f3f3" style="color: #000; font-size: 20px;text-transform: capitalize;font-family: 'Montserrat', sans-serif; padding: 10px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="font-family: 'Montserrat', sans-serif;">
        <tr style="background: #f3f3f3;">
          ...
          <td width="60%" align="right"><span style="height: 22px; display: block; background: #fff; border: solid 1px #bbb; padding-right: 15px;"><?php echo $policylist['policynumber']; ?></span></td>
        </tr>
        <tr style="background: #f3f3f3;">
        ...
        <tr style="background: #f3f3f3;">
          ...
          <td width="60%" align="right"><span style="height: 22px; display: block; background: #fff; border: solid 1px #bbb; padding-right: 15px;"><?php echo dateFormFormat($insuredInfo['effectivedate'],"m/d/y"); ?></span></td>
        </tr>
      </table>
    </th>
  </tr>
    ...
    <td colspan="10">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <?php 
              ...
              $rateups = getRateUpsByInsured($insuredInfo['id']);
        ...
        <tr>
          <td align="center" style="color: #000;padding:8px 8px;font-size: 12px;">
            <?php echo $rateuptype['detaileng'];?>
          </td>
          <td align="center" style="color: #000;padding:8px 8px;font-size: 12px;">
            <?php echo $rateuptype['detailspa'];?>
          </td>
        </tr>
        <?php }} ?>
      </table>

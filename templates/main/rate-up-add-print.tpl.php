<?php
global $rateupinfo,$db,$rateup_info,$footerFunctions;
    ...
    <th colspan="4" bgcolor="#f3f3f3" style="color: #000; font-size: 20px;text-transform: capitalize;font-family: 'Montserrat', sans-serif; padding: 10px;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="font-family: 'Montserrat', sans-serif;">
        ...
        <tr style="background: #f3f3f3;">
          ...
          <td width="60%" align="right"><span style="height: 22px; display: block; background: #fff; border: solid 1px #bbb; padding-right: 15px;"><?php echo $insured_info['first_name'].' '.$insured_info['last_name']; ?></span></td>
        </tr>
        <tr style="background: #f3f3f3;">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="7" align="left" style="padding: 0;">
              <span style="font-size: 14px;"><strong>Name of insured:</strong> <?php echo $insured_info['first_name'].' '.$insured_info['last_name']; ?></span>
            </td>
          </tr>
        </table>
      </td>

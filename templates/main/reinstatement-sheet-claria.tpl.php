...
<table align="center" width="800" border="0" cellpadding="0" cellspacing="0" bgcolor="#ffffff" style="font-family: 'Montserrat', sans-serif;font-size: 11px;">
  ...
  <tr style="background-color: #fff;">
    <th colspan="9" align="right" style="padding: 10px;color: #000; font-size: 20px;text-transform: capitalize;font-family: 'Montserrat', sans-serif;">REINSTATEMENT SHEET
    </th>
  </tr>
  <tr rowspan="3" style="background-color: #fff;">
    <th colspan="6" valign="top" align="left" style="color: #000; font-size: 20px;text-transform: capitalize;font-family: 'Montserrat', sans-serif;">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
          <td><br><br>
            <span style="font-size: 19px;"><strong>REINSTATEMENT APPROVED WITH:</strong></span><br><br>
    ...
    <td colspan="10">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <?php foreach($insuredLists as $singleinsured){
              $rateups = getRateUpByInsured($singleinsured['id']);
              if($rateups['idrateuptype'] == 1){$rateupsText = '10% Smoker';}
              elseif($rateups['idrateuptype'] == 2){$rateupsText = '10% Over-weight';}
              elseif($rateups['idrateuptype'] == 3){$rateupsText = '15% Over-weight';}
              elseif($rateups['idrateuptype'] == 4){$rateupsText = '25% Over-weight';}
              elseif($rateups['idrateuptype'] == 5){$rateupsText = '50% Over-weight';}
              elseif($rateups['idrateuptype'] == 6){$rateupsText = '75% Over-weight';}
              elseif($rateups['idrateuptype'] == 7){$rateupsText = '100% Overweight';}
              elseif($rateups['idrateuptype'] == 8){$rateupsText = '25% Spain Student';}
              elseif($rateups['idrateuptype'] == 9){$rateupsText = 'Student in The US';}
              //echo '<pre>';
              //print_r($rateups);  
        ?>
        <tr>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo getHealthPrimaryInsuredFirstName($policyInfo['id']); ?></td>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo getHealthPrimaryInsuredLastName($policyInfo['id']); ?></td>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo $rateupsText; ?></td>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo $rateups['amount']; ?></td>
        </tr>
        <?php }?>
      </table>
    </td>
  ...
  <tr>
    <td colspan="10">
      <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        ?>
        <tr>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo $rData['name']; ?></td>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo $rData['title']; ?></td>
          <td style="color: #000;padding:8px 8px;font-size: 12px;"><?php echo $rData['details'];?></td>
        </tr>
        <?php 
                }
            }

...
$newRiderNumber = generateRiderNumber($insuredInfo['idpolicy']);
...
<div class="sectionPanel_Right">
    <div class="content_section">
        ...
        <div class="title_bar">
            ...
            <div class="btn btn-primary bgwhite"><a href="<?php echo THE_URL."main/rider/".$insuredInfo['id']; ?>">Close</a></div>
            <div class="btn btn-primary "><a href="#">Delete</a></div>
        </div>
        
        <!-- Content Section Starts Here -->
        
        <form method="post" action="<?php echo THE_URL.'main/rider_save' ?>" id="frm_new_rider"  enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="form-group-section">                            
                            ...
                            <input type="text" class="form-control" name="rider_number" value="<?php echo $riderInfo ? $riderInfo['rider_number']: $newRiderNumber; ?>"/>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="form-group-section">
                            <label class="formheading">Name</label>
                            <input type="text" class="form-control" name="name" value="<?php  echo $riderInfo ? $riderInfo['name'] : $insuredInfo['first_name']." ".$insuredInfo['last_name']; ?>"/>
                        </div>
                    </div>
                        ...
                        <div class="form-group-section">
                            ...
                            <span class="form-select">
                                <select class="form-control" name="status">
                                    ...
                                    <option value="1" <?php if($riderInfo['status']==1) echo 'selected="selected"'; ?>>Received</option>
                                    <option value="2" <?php if($riderInfo['status']==2) echo 'selected="selected"'; ?>>Benefits Increased Pending</option>
                                </select>
                            </span>
                        </div>
                      </div>

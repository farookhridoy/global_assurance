        ...
        <div class="col-md-8">
          <div class="paymode_status">
            <ul>
              ...
              <li><span>Status</span><p><?php echo $pStatus;?></p></li>
            </ul>
          </div>
        </div>
        <div class="col-md-4">
                ...
                <div class="parentof_tabl">
                  <div class="tabl">
                    ...
                    <div class="tabl_row" id="agent_frm1">
                      ...
                      <div class="tabl_cell">                      
                        <span class="form-select">
                          <select class="form-control payment_policy_agents" name="agent_level1" id="agent_level1" data-id="1">
                            ...
                            <?php $agentLists = getAgentLists('health',1); if($agentLists){foreach($agentLists as $al_key => $al_vl){ $selected_text = ($policyInfo['idagent'] == $al_vl['id']) ? 'selected="selected"': '';   echo '<option value="'.$al_vl['id'].'" '.$selected_text.'>'.$al_vl['name'].'</option>';}} ?>
                          </select>
                        </span>
                      </div>
                      <?php
                      if($agentLists){
                        foreach($agentLists as $al_key => $al_vl){ 
                      ...
                      ?>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_f_name" name="agent_level1_f_name"  class="form-control" value="<?php echo $fName1;?>" /> </div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_l_name" name="agent_level1_l_name" class="form-control" value="<?php echo $lName1;?>" /> </div>                                
                      <div class="tabl_cell"> <input type="text" id="agent_level1_commission" name="agent_level1_commission" class="form-control widthsm" value="<?php echo $commission1;?>" /></div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_sys_nb" name="agent_level1_sys_nb" class="form-control widthsm" value="<?php echo $sys_nb1;?>" /></div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_nb" name="agent_level1_nb" class="form-control widthsm" value="<?php echo $nb1;?>" /></div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_sys_rn" name="agent_level1_sys_rn" class="form-control widthsm" value="<?php echo $sys_rn1;?>" /></div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_rn" name="agent_level1_rn" class="form-control widthsm" value="<?php echo $rn1;?>" /></div>
                      <div class="tabl_cell"> <input type="text" id="agent_level1_pay_by" name="agent_level1_pay_by" class="form-control widthsm" value="<?php echo $pay_by1;?>" /></div>
                      <div class="tabl_cell">
                      ...
                      <div class="tabl_cell">                      
                        <span class="form-select">
                          <select class="form-control payment_policy_agents" name="agent_level2" id="agent_level2" data-id="2">
                            <option value="0"></option>
                            <?php $agentLists2 = getAgentLists('health',2); if($agentLists2){foreach($agentLists2 as $al_key => $al_vl){ $selected_text = ($policyInfo['idagent'] == $al_vl['id']) ? 'selected="selected"': '';   echo '<option value="'.$al_vl['id'].'" '.$selected_text.'>'.$al_vl['name'].'</option>';}} ?>
                          </select>
                        </span>
                      </div>
                      <?php
                      ...
                      <div class="tabl_cell">                      
                        <span class="form-select">
                          <select class="form-control payment_policy_agents" name="agent_level3" id="agent_level3" data-id="3">
                            <option value="0"></option>
                            <?php $agentLists3 = getAgentLists('health',3); if($agentLists3){foreach($agentLists3 as $al_key => $al_vl){ $selected_text = ($policyInfo['idagent'] == $al_vl['id']) ? 'selected="selected"': '';   echo '<option value="'.$al_vl['id'].'" '.$selected_text.'>'.$al_vl['name'].'</option>';}} ?>
                          </select>
                        </span>
                      </div>
                      <?php
                      ...
                      <div class="tabl_cell">                      
                        <span class="form-select">
                          <select class="form-control payment_policy_agents" name="agent_level4" id="agent_level4" data-id="4">
                            <option value="0"></option>
                            <?php $agentLists4 = getAgentLists('health',4); if($agentLists4){foreach($agentLists4 as $al_key => $al_vl){ $selected_text = ($policyInfo['idagent'] == $al_vl['id']) ? 'selected="selected"': '';   echo '<option value="'.$al_vl['id'].'" '.$selected_text.'>'.$al_vl['name'].'</option>';}} ?>
                          </select>
                        </span>
                      </div>
                      <?php
                    ...
                    <div class="tabl_row" id="agent_frm5">
                      ...
                      <div class="tabl_cell">                      
                        <span class="form-select">
                          <select class="form-control payment_policy_agents" name="agent_level5" id="agent_level5" data-id="5" >
                            <option value="0"></option>
                            <?php $agentLists5 = getAgentLists('health',5); if($agentLists5){foreach($agentLists5 as $al_key => $al_vl){ $selected_text = ($policyInfo['idagent'] == $al_vl['id']) ? 'selected="selected"': '';   echo '<option value="'.$al_vl['id'].'" '.$selected_text.'>'.$al_vl['name'].'</option>';}} ?>
                          </select>
                        </span>
                      </div>
                      <?php
                      ...
                      <div class="tabl_cell">
                        <!-- $hideshow = isset($policyInfo['idagent'])? $fName2 ==null? 'hiddenbtn' : '':'hiddenbtn' -->
      ...
      <div class="col-md-7">
        ...
        <div class="content_section_aside">
          <div class="row">
            ...
            <div class="col-md-5">
              <button class="btn btn-primary bgorange float-right">Add</button>
            </div>
          </div>
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-11">
                <input type="text" class="form-control" value="<?=$noteData['note_1']?>">
              </div>
            </div>
          </div>
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-11">
                <input type="text" class="form-control"  value="<?=$noteData['note_2']?>">
              </div>
            </div>
          </div>  
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-11">
                <input type="text" class="form-control"  value="<?=$noteData['note_3']?>">
              </div>
            </div>
          </div> 
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-11">
                <input type="text" class="form-control"  value="<?=$noteData['note_4']?>">
              </div>
            </div>
          </div> 
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-11">
                <input type="text" class="form-control"  value="<?=$noteData['note_5']?>">
              </div>
            </div>
          </div> 
        ...
        <div class="content_section_aside">
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-9">
                <input type="text" class="form-control" name="receipt_pay">
              </div>
            </div>
          </div>
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              ...
              <div class="col-md-12 col-lg-9">
                <input type="text" class="form-control" name="receipt_type">
              </div>
            </div>
          </div>  
          ...
          <div class="form-group-row">
            <div class="row rowsm">
              <div class="col-md-12 col-lg-3"><label class="formheading labelSide">Note</label></div>
              <div class="col-md-12 col-lg-9">
                <textarea class="form-control form-textarea" name="receipt_note"></textarea>
              </div>
            </div>
          </div> 
        </div><!-- content_section_aside END -->
    ...
    <div class="row">
      <div class="col-md-12"> 
        <div class="content_section_aside" id="content_section_payments">
          <div class="table_overlay">
            <table class="tableContent tableHover">
              <tr>
                ...
                <tr class="row_payment" id="row_payments_base" data-id="0" style="display: none;">
                <td>
                ...
                <td>
                  ...
                  <td><input type="text" name="paymentpaid" class="input-no-border useDatePicker datepicker-dob" value="" size="7"/></td>
                  ...
                  <td>
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="locked" id="lockedlabel" value="0">
                        <label for="lockedlabel"></label>
                      </div>
                    </td>
                    <td>
                      <span class="form-select tableselect_height">
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="paidcheck" id="paidlabel" value="0">
                        <label for="paidlabel"></label>
                      </div>
                    </td>
                  </tr>
              ...
              <tr class="row_payment" id="row_payment<?php echo $ins_loop; ?>" data-id="<?php echo $ins_loop; ?>" >
                ...
                <td>
                  ...
                  <td><input type="text" name="paymentpaid" class="input-no-border useDatePicker datepicker-dob" value="<?=$payments_value['date_paid'] ?>" size="7"/></td>
                  <td><input type="text" name="paymentduedate" class="input-no-border useDatePicker datepicker-dob" value="<?=$payments_value['date_due'] ?>" size="7"/></td>
                  ...
                  <td>
                    ...
                    <td>
                      <div class="checkbxs">
                        <?php  $checked_text =($payments_value['locked'] == 1) ? 'checked="checked"': '' ?>
                        <input type="checkbox" <?= $checked_text?> name="locked" id="lockedlabel<?php echo $payments_key;  ?>" value="<?= isset($payments_value)? $payments_value['locked']:1 ?>">
                    ...
                    <td>
                      <div class="checkbxs">
                        <?php  $checked_text =($payments_value['paid'] == 1) ? 'checked="checked"': '' ?>
                        <input type="checkbox" <?= $checked_text?> name="paidcheck" id="paidlabel<?php echo $payments_key;  ?>" value="<?= isset($payments_value)? $payments_value['paid']:1 ?>">
          ...
          ?>
          <tr class="row_payment" id="row_payment1" data-id="1">
                <td>
                  <span class="form-select tableselect_height">
                    <select id="paymentType" class="form-control  minselect-width" name="paymenType">
                      <option>&nbsp;</option>
                  ...
                  <td>
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="locked" id="lockedlabelfirst" value="1">
                        <label for="lockedlabelfirst"></label>
                      </div>
                    </td>
                    <td>
                      <span class="form-select tableselect_height">
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="paidcheck" id="padilabelfirst" value="1">
                        <label for="padilabelfirst"></label>
                      </div>
                    </td>
                  </tr>
          <?php } ?>    
          <tr>
              <td><span id="addPaymentRow" title="Add new row"><a href="javascript: void(0)">+</a></span></td>
              <td></td>
              <td></td>
              <td></td>
              <td></td>

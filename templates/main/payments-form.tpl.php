              ...
              <tr>
                ...
                <td>
                  ...
                  <td>
                    ...
                    <td><input type="text" name="payment_user_id" class="input-no-border" size="6" value=""/></td>
                    <td>
                      <div class="checkbxs">
                        
                        <input type="checkbox" name="locked" id="lockedlabel" />
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="paidcheck" id="paidlabel" />
              ...
              <tr class="row_payment" id="row_payment<?php echo $ins_loop; ?>" data-id="<?php echo $ins_loop; ?>" >
                ...
                <td>
                  ...
                  <td>
                    ...
                    <td><input type="text" name="payment_user_id" class="input-no-border" size="6" value="<?php echo $payments_value['id_user'];?>"/></td>
                    <td>
                      <div class="checkbxs">
                  ...
                  <td>
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="locked" id="lockedlabelfirst" />
                    ...
                    <td>
                      <div class="checkbxs">
                        ...
                        <input type="checkbox" name="paidcheck" id="padilabelfirst">

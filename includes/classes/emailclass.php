 ...
 * @copyright	Copyright (c) 2009, TrenzaSoftwares, http://trenzasoft.com.
...
class emailclass {
	...
	var $SHOW_ERROR = FALSE;//TRUE TO THIS $SHOW_ERROR DISPLAY ANY TYPE OF MYSQL ERROR; //FALSE TO DO NOTING

	var	$useragent		= "TRZ_Mail";
	...
	function emailclass($config = array())
...

	{
...

		{
			...
			$this->_set_error_message('', $this->_get_protocol());
